...
object AutoLanguageIcons {
     ...
     */
    val LOGO_16: Icon = IconLoader.getIcon("/icon/logo-16_16x16.svg", AutoLanguageIcons::class.java)
    
    /**
     * أيقونة متوسطة (32x32) - للأشرط الجانبية والأدوات
     * Medium icon (32x32) - for sidebars and tools
     */
    val LOGO_32: Icon = IconLoader.getIcon("/icon/logo-16_32x32.svg", AutoLanguageIcons::class.java)
    
    /**
     * أيقونة كبيرة (64x64) - الشعار الرئيسي للإضافة
     * Large icon (64x64) - main plugin icon
     */
    val LOGO_64: Icon = IconLoader.getIcon("/icon/logo-16_64x64.svg", AutoLanguageIcons::class.java)
    
    /**
     * أيقونة كبيرة جداً (128x128) - لصفحة الإضافات والشاشات الكبيرة
     * Very large icon (128x128) - for plugin page and large screens
     */
    val LOGO_128: Icon = IconLoader.getIcon("/icon/logo-16_128x128.svg", AutoLanguageIcons::class.java)
